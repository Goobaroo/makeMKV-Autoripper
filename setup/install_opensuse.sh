...
if [[ ! $(which makemkvcon) ]]; then
	sudo add-apt-repository ppa:stebbins/handbrake-releases
	sudo zypper update
	sudo zypper install python build-essential libc6-dev libssl-dev libexpat1-dev libgl1-mesa-dev libqt4-dev g++ python-imdbpy handbrake-cli
fi
